...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
       ...
       // mImageLayer.contents = (id)[UIImage imageNamed:@"2.png"].CGImage;
        ...
        mImageLayer.borderColor = [UIColor redColor].CGColor;
       ...
       mCellTtleLabel = [[UILabel alloc] initWithFrame:CGRectMake(44.0, 10.0, self.contentView.bounds.size.width - 44.0, 21.0)];
        ...
        mCellTtleLabel.font = [UIFont fontWithName:@"Futura-Medium" size:24.0];
...
-(void)layoutSubviews
{
    ...
    mCellTtleLabel.frame = CGRectMake(heightOfImageLayer+15.0, floorf(heightOfImageLayer/2.0 - (21/2.0f))+4.0, self.contentView.bounds.size.width-heightOfImageLayer+15.0, 31.0);
...
-(void)setSelected:(BOOL)selected animated:(BOOL)animated
{
    ...
    mImageLayer.borderColor = selected ? [UIColor redColor].CGColor : [UIColor whiteColor].CGColor;
    mCellTtleLabel.textColor = selected ? [UIColor redColor] : [UIColor whiteColor];
}
