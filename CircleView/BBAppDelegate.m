...
@synthesize analysisImage = _analysisImage;
@synthesize analysisImageIndex = _analysisImageIndex;
...
//    [TestFlight takeOff:@"d0939301-0ca8-4729-a027-b5c5eca457a8"];
    
    self.analysisImageIndex = 0;
    return YES;
}
